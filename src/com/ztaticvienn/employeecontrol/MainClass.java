...
public class MainClass {
    ...
    mycompany.addHourlyWageEmployee(3, "Will", "Lewis", 1976, 3, 18, Gender.MALE, 4.0);
    mycompany.addHourlyWageEmployee(4, "Jane", "Johnson", 1976, 4, 11, Gender.FEMALE, 12.0);
    mycompany.addFixedSalaryEmployee(5, "George", "McCarter", 1984, 3, 15, Gender.MALE, 2300.0);
    mycompany.ShowAllEmployees();

    mycompany.ShowEmployees(2,4);
    }
